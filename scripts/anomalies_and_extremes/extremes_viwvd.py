...
input_folder = "/LFASGI/sandroal/data_sets/ERA_INTERIM/" + \
               "vertical_integral_of_divergence_of_moisture_flux_daily/"

# Where to put results.
output_folder = "/LFASGI/sandroal/data_sets/ERA_INTERIM/" + \
                "vertical_integral_of_divergence_of_moisture_flux_extremes_ano/"

# Data extension ("grb" or "nc").
extension = "nc" # Use netcdf here (renamed). 
                 # Do not use grib files (not renamed).
